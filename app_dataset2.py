...
def load_base_vocabulary():
    ...
    base_model_path = os.path.join(SCRIPT_DIR, 'mlp_text_model_dataset2.pth')
    ...
    candidates = [
        os.path.join(SCRIPT_DIR, 'vocab_data_dataset2.pkl'),
        os.path.join(os.path.expanduser('~/Downloads'), 'vocab_data_dataset2.pkl'),
    ]
    for p in candidates:
...
examples = [
    ...
    "use the command to",
    "filesystem drivers can be",
    "the process scheduler will",
